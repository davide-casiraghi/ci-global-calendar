...
__webpack_require__(/*! ./plugins/gallery */ "./resources/js/plugins/gallery.js"); // gallery.js


__webpack_require__(/*! ./plugins/imagepopup */ "./resources/js/plugins/imagepopup.js"); // imagepopup.js


__webpack_require__(/*! ./plugins/statistics */ "./resources/js/plugins/statistics.js"); // statistics.js


__webpack_require__(/*! ./utility/selectpicker_mobile */ "./resources/js/utility/selectpicker_mobile.js"); // File manager for intro_image button in edit.post view


__webpack_require__(/*! ./plugins/laravel-filemanager/lfm */ "./resources/js/plugins/laravel-filemanager/lfm.js"); // lfm.js


__webpack_require__(/*! ./plugins/laravel-filemanager/editPostImageFilemanager */ "./resources/js/plugins/laravel-filemanager/editPostImageFilemanager.js"); // editPostImageFilemanager.js
...
throw new Error("Module build failed (from ./node_modules/vue-loader/lib/index.js):\nError: [vue-loader] vue-template-compiler must be installed as a peer dependency, or a compatible compiler implementation must be passed via options.\n    at loadTemplateCompiler (/Users/davidecasiraghi/Documents/Sync/www/myJob/@github/ci-global-calendar/node_modules/vue-loader/lib/index.js:21:11)\n    at Object.module.exports (/Users/davidecasiraghi/Documents/Sync/www/myJob/@github/ci-global-calendar/node_modules/vue-loader/lib/index.js:65:35)");
...
/***/ "./resources/js/plugins/imagepopup.js":
/*!********************************************!*\
  !*** ./resources/js/plugins/imagepopup.js ***!
  \********************************************/
/*! no static exports found */
...
function wrapImageWithAlt(thisObj) {
  ...
  var descriptionText = description.parent(".imageWrapper").children("img").attr('alt'); //remove # from alt and add <br> to description (#is <br> marker)

  descriptionTextNoAlt = descriptionText.replace("#", "");
  description.parent(".imageWrapper").children("img").attr('alt', descriptionTextNoAlt); // add br to description

  descriptionText = descriptionText.replace("#", "<br/>"); // create description under images

  description.append(descriptionText);
  description.parent(".imageWrapper").css('float', description.parent(".imageWrapper").children("img").css('float'));
  var wrapperWidth = description.parent(".imageWrapper").children("img").width(); //alert(wrapperWidth);

  description.parent(".imageWrapper").css('width', wrapperWidth);
  description.parent(".imageWrapper").children('.imgDesc').css('float', description.parent(".imageWrapper").children("img").css('float')); //description.css('width',description.parent(".imageWrapper").children("img").attr('width'));

  description.css('width', wrapperWidth); //remove alt text

  jQuery(this).attr('alt', ""); // gestione immagine centrata (centratura descrizione)
...
function wrapImageWithoutAlt(thisObj) {
  ...
  var centerViaWord = thisObj.parent().css('text-align'); // Incapsula l'immagine con ALT della sezione news in un contenitore

  jQuery(this).wrap('<div class="imageWrapper" style="width:' + wrapperWidth + 'px; float:' + wrapperFloat + ';"/>'); // gestione immagine centrata (centratura descrizione)
...
jQuery(document).ready(function () {
  ...
  jQuery(".postBody img, .zoomImage").not(".no_zoomImage").not(".gallery img").not(".featurette-image").not(".columns img").each(function (index) {
    ...
    var current_img = jQuery(this); // GET ACTUAL IMG SIZE

    var src = current_img.attr('src');
    var actual_width = current_img.attr('width');
    var actual_height = current_img.attr('height'); // GET REAL IMG SIZE

    var url = jQuery(this).attr("src");
    pic_real_width = jQuery(this).width;
    pic_real_height = jQuery(this).height;
    link_width = parseInt(actual_width);
    link_height = parseInt(actual_height); // IF ORIGINAL SIZE DIFFER FROM REAL IMG SIZE

    if (actual_width != pic_real_width || actual_height != pic_real_height) {
      // Add class zoomable
      current_img.addClass('zoomable'); // Assign random ID to the image & append lens
      ...
      current_img.wrap("<a id=ID" + uniqueNum + " href=" + src + " style='width:" + link_width + "px;height:" + link_height + "px; display:block;'></a>").parent().append("<div style='clear:both;'></div><div class='lens' style='top:" + topValue + "px;right:" + rightValue + "px;'></div>"); // Assign Fancybox action to the element
      ...
      jQuery("a#ID" + uniqueNum).fancybox({
        ...
        current_img.css({
          display: 'block'
        }); // fix to solve description problem alignment for images without popup
...
/***/ "./resources/js/plugins/laravel-filemanager/editPostImageFilemanager.js":
/*!******************************************************************************!*\
  !*** ./resources/js/plugins/laravel-filemanager/editPostImageFilemanager.js ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./resources/js/plugins/laravel-filemanager/lfm.js":
/*!*********************************************************!*\
  !*** ./resources/js/plugins/laravel-filemanager/lfm.js ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./resources/js/plugins/statistics.js":
/*!********************************************!*\
  !*** ./resources/js/plugins/statistics.js ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./resources/js/utility/selectpicker_mobile.js":
/*!*****************************************************!*\
  !*** ./resources/js/utility/selectpicker_mobile.js ***!
  \*****************************************************/
/*! no static exports found */
...
__webpack_require__(/*! /Users/davidecasiraghi/Documents/Sync/www/myJob/@github/ci-global-calendar/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/davidecasiraghi/Documents/Sync/www/myJob/@github/ci-global-calendar/resources/sass/app.scss */"./resources/sass/app.scss");
