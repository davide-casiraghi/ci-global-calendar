...
__webpack_require__(93); // statistics.js
...
jQuery(document).ready(function () {
    ...
    jQuery(".postBody img, .zoomImage").not(".no_zoomImage").not(".gallery img").not(".featurette-image").not(".columns img").each(function (index) {
        ...
        if (actual_width != pic_real_width || actual_height != pic_real_height) {
            ...
            current_img.wrap("<a id=ID" + uniqueNum + " href=" + src + " style='width:" + link_width + "px;height:" + link_height + "px; display:block;'></a>").parent().append("<div style='clear:both;'></div><div class='lens' style='top:" + topValue + "px;right:" + rightValue + "px;'></div>");
