...
<div class="container max-w-md px-0">
    <div class="row">
        <div class="col-12">
            <h4>
                <i data-toggle="tooltip" data-placement="top" title="" class="far fa-hand-holding-usd ml-2 mr-3 dark-gray"></i>
                @lang('donations.financial_contributions')
            </h4>
        </div>
    </div>
