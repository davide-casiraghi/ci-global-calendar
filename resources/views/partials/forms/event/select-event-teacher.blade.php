...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-6 mt-0 mt-sm-2">
        <button type="button" data-toggle="modal" class="btn btn-primary mb-3 mb-sm-0 mt-sm-4" data-remote="{{ route('teachers.modal') }}" data-target=".modalFrame"><i class="fa fas fa-plus-circle "></i> @lang('views.create_new_teacher')</button>
    </div>
</div>
