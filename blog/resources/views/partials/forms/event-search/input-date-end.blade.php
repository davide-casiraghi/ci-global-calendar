...
<div class="form-group">
    <div class="input-group input-append date datepicker_end_date">
        ...
        <input name="endDate" class="form-control" type="text" placeholder="Select date" @if(!empty($searchEndDate)) value="{{ $searchEndDate }}"@endif readonly="readonly" aria-describedby="date-addon-end">
    </div>
</div>
